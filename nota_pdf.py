...
def gerar_comprovante_pedido_pdf(pedido, itens, estabelecimento):
    ...
    informacoes = [
        ...
        [Paragraph("<b>Recebimento</b><br/>" + texto("Retirada na loja" if pedido["modalidade_entrega"] == "RETIRADA" else "Entrega") + "<br/>" + texto(pedido["local_entrega"] or "Local não informado") + "<br/>" + texto(pedido["endereco"]), corpo), Paragraph("<b>Pagamento</b><br/>" + texto(pedido["forma_pagamento"]), corpo)],
